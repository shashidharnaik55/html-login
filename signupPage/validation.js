$(document).ready(function () {
  ...
  function validateUsername() {
    ...
    if (usernameValue.length == '') {
      ...
      usernameError = false
      return false
    } else if (usernameValue.length < 5 || usernameValue.length > 8) {
      $('#usercheck').show()
      $('#usercheck').html('**length of username must be between 5 and 8')
      usernameError = false
      return false
    } else {
      $('#usercheck').hide()
  ...
  function validatePassword() {
    ...
    if (passwrdValue.length < 5 || passwrdValue.length > 10) {
      $('#passcheck').show()
      $('#passcheck').html('**length of your password must be between 5 and 10')
  ...
  $('#loginbtn').click(function () {
    validatelogUsername()
    validatelogPassword()
    if (logusernameError == true && logpasswordError == true) {
      return true
    } else {
      return false
    }
